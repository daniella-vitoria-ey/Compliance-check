...
def clean_reason(reason: str) -> str:
    ...
    # remove prefixos chatos se vier algo como "is_compliant: false" e "reason:"
    ...
    # remove espaços/quebras duplicadas
...
def parse_llm_response(raw_response: str) -> dict:
    ...
    # tenta extrair apenas o bloco JSON, se vier texto extra antes/depois
    ...
    for candidate in candidates:
        ...
        # tentativa 2: Python dict literal
        try:
